...
function InicializarTablero(partida, callback) {
    ...
    conexion.connect(function (err) {
        if (!err) {
            var sql = "select partidas.ID as partida , usuario.ID as user from partidas,usuario where partidas.Nombre ='" + partida + "'and partidas.Creador = usuario.Nombre_usuario;";
            ...
            conexion.query(sql, function (err, resultado) {
                if (!err) {
                    ...
                    sql = "INSERT INTO `poner` (`ID`, `ID_Usuario`, `ID_Partida`, `ID_Carta`, `Fila`, `Columna`, `Descubierta`) " +
                            "VALUES (NULL, '" + creador + "', '" + ID_partida + "', '1', '" + 3 + "', '" + 0 + "', '1');";
