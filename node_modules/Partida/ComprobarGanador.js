...
function saleDelTableroSaboteador(tipo, procedencia, f, c) { // Esta funcion devuelve que si en caso de que las direcciones de la casilla esten cortadas porque van hacia fuerta del tablero, lo marca como camino cortado
    var imposible = false;

    if (tipo.indexOf("u") !== -1 && procedencia !== "d") {
        if (f - 1 < 0) {
            imposible = true;
        } else {
            imposible = false;
    ...
    if (tipo.indexOf("d") !== -1 && procedencia !== "u") {
        if (f + 1 > 6) {
            imposible = true;
        } else{
            imposible = false;
    ...
    if (tipo.indexOf("r") !== -1 && procedencia !== "l"){
        if( c + 1 > 6) {
            imposible = true;
        } else{
            imposible = false;
    ...
    if (tipo.indexOf("l") !== -1 && procedencia !== "r"){ 
        if(c - 1 < 0) {
            imposible = true;
        } else{
            imposible = false;
