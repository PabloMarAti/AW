...
function LeerPartidasAbiertas(usuario, callback) {
    ...
    conexion.connect(function (err) {
        if (err) {
            ...
            var sql = "select Nombre, Creador, Estado, Numero_Jugadores, GROUP_CONCAT(DISTINCT usuario.Nombre_Usuario SEPARATOR ', ') as JugadoresUnidos " +
                      "from partidas, juega, usuario " + 
                      "where partidas.Estado = 'Abierta' and partidas.Creador != '" + usuario + "' and partidas.ID = juega.ID_Partida AND juega.ID_Usuario = usuario.ID " +
